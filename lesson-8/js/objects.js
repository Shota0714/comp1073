...
const person = {
    ...
    age: 23,
    gender: "male",
    interests: ["baseball", "photographing"],
    greeting() {
        let greeting = `Hi, my name is ${this.name.first} ${this.name.last} and I am ${this.age} years old. One of my interests is ${this.interests[0]}.`;
        return greeting;
    }
};
